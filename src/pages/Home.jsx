  ...
  return (
   ...
   <main className='bg-gray-50'>
      <section className='px-8 pb-15'>
        ...
        <div className='flex flex-col text-center gap-4'><h1 className='text-3xl font-semibold text-indigo-500'>Land Your Dream Job with Smarter Resume Reviews</h1>
      ...
      <section className='px-8 pb-15'>
        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3">
          {testimonials.map((t, index) => (
            ...
            >
              <p className="text-[0.75rem] text-gray-500  mb-4">"{t.quote}"</p>
