...
const Navbar = ({loggedIn, setloggedIn}) => {
  ...
  return (
    <>
    <div className='relative px-4 bg-indigo-100 py-6'>
 ...
 to="/">Home</Link>
       <Link className='hover-underline text-gray-600' to="/login">Login</Link>
        ...
        {hamOn&&
          <div className='md:hidden absolute right-0 top-13 h-56 bg-indigo-100 z-99  w-full py-1 flex flex-col justify-center items-end pr-5 text-[0.9rem] font-semibold  gap-5'>
